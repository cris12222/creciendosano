...
def CreateEvento(request):
    ...
    return render(request,'home/ui-icons.html',{'temas':temas,'metas':metas,'eventoform':eventoform,'eventos':eventos})
    ...
    if request.method=='POST':
        ...
        if fechaform.is_valid():
            ...
            for evento in eventos:
                ...
                totalfin_personas+=total_personas
                totalfin_mujeres+=evento.cant_mujeres
                totalfin_hombres+=evento.cant_hombres
                info_evento = {
                    'area': evento.area,
            ...
            return render(request, 'home/ui-maps.html', {'finm':totalfin_mujeres,'finh':totalfin_hombres,'fin':totalfin_personas,'context':lista_eventos,'mes':fecha_inicio,'año':fecha_fin,'fechaform':fechaform})
